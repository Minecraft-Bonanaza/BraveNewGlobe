...
**As of 0.9.0** (unchanged through **0.9.5**) the book is complete: **15 chapters, 230 quests**.
...
Achievement**); exploration lines are locate-and-progress. 0.9.1–0.9.5 did not touch quests
(LootJS / Simply Swords / Nether content — see [LOOT.md](LOOT.md) and [Notes.md](Notes.md)).
...
## Candidate additions (not in the 0.9.0 / 0.9.5 book)
- **Nether (Incendium / Born in Chaos / Better Fortresses)** — exploration line; not in v1.
  Overworld BiC gameplay structures generate as of 0.9.5; Incendium is Nether-only. Overworld
  BiC mob spawns are still pending review.
