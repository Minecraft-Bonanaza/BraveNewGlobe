...
**Shipped book (as of 0.9.10, still current in 0.9.23):** **17 chapters / 242 quests**.
...
3. **Aeronautics** — Aeronautics, Sable, Aeroworks, Gyro, hose connectors, radars, AeroPortals (portal transit), Radiologistics (tower comms); capstone = reach the sky structures.
...
- **ComputerCraft / Radiologistics** — fold into Aeronautics / Cannons later if quested; **not** an 18th shipped chapter. Book stays **17 / 242**.
