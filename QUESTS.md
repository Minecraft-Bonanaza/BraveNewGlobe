...
**As of 0.9.0** (unchanged through **0.9.6**) the book is complete: **15 chapters, 230 quests**.
...
Achievement**); exploration lines are locate-and-progress. 0.9.1–0.9.6 did not touch quests
(LootJS / Simply Swords / Nether content / Simply More bump — see [LOOT.md](LOOT.md) and
[Notes.md](Notes.md)).
...
## Candidate additions (not in the 0.9.0 / 0.9.6 book)
