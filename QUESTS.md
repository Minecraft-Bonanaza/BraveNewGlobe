...
**Shipped book (as of 0.9.10, still current in 0.9.26):** **17 chapters / 242 quests**.
...
3. **Aeronautics** — Aeronautics 1.3.2, Sable, Aeroworks, Gyro, hose connectors, radars, Gadgets & Gizmos (thrusters + flight controls + CC), AeroPortals, Radiologistics; capstone = reach the sky structures. CC: Tweaked scripts the ship's brain.
...
9. **Commerce** — Numismatics (+ Villager Currency, Tradeworks, Marketplace, Stock Market, Bountiful/Bounties) plus in-house **Create: Market Maker**. Earned currency, physical fulfillment; no minting.
