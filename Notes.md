...
0.7.18 is **Create: Villager Commerce** `1.0.1` (relaunch; no worldgen). Another
**unversioned** add after 0.7.18 is **[SPECTRUM.md](SPECTRUM.md)** (SIG / FTB Quests
design doc; FTB Quests is **not** in the pack). **0.7.17** / **0.7.18** swap the coin
economy to **Create: Numismatics** (plus Delivery Required and the shop/stock-market
...
unversioned add after 0.7.16 is two Create/Sable mods; **0.7.17** / **0.7.18** are
economy mods; unversioned after 0.7.18 is SPECTRUM.md then Villager Commerce).
...
- From **0.7.1 → 0.7.18** (including the unversioned adds after 0.7.16 and 0.7.18) — **no**
  fresh world for height. 0.7.1–0.7.15 are datapack-only WDA placement retunes; **0.7.16**
  adds Better Combat; the unversioned add after 0.7.16 is two Create/Sable mods;
  **0.7.17** / **0.7.18** swap the coin economy (no worldgen); unversioned after 0.7.18
  is SPECTRUM.md then **Villager Commerce**. Relaunch.
...
adds after 0.7.16 and 0.7.18, and **0.7.17** / **0.7.18** did not touch WDA.
...
Market / Utils), Create Aeronautics: Delivery Required, Create: Villager Commerce, and
...
**`MODLIST.md`** is a human-readable grouped list of all **136** mods (as of the
unversioned Villager Commerce add after 0.7.18; 129 when first added, 135 as of 0.7.18).
...
## Create: Villager Commerce (unversioned after 0.7.18)
**Create: Villager Commerce** `1.0.1` (CurseForge 1557618 / file 8183116,
`pack/mods/create-villager-commerce.pw.toml`) landed in author commit `5dce09f`
("Added Villager Commerce") while `pack.toml` stayed **0.7.18**. `side = "both"`.
No worldgen. **No fresh world.** Relaunch so packwiz adds the jar.
...
[`MODLIST.md`](MODLIST.md) (count is **136**).

## SPECTRUM — SIG / FTB Quests design (unversioned after 0.7.18)
**[`SPECTRUM.md`](SPECTRUM.md)** (author commit `41ec107`, "Spectrum.md") is the living
framework for designing **FTB Quests** around player specialization. `pack.toml` stayed
**0.7.18**. No mods, datapacks, or configs changed.
...
**FTB Quests is not in the pack.** Do not document a shipped questbook. When a quest mod
is added, keep SIG IDs stable and update `SPECTRUM.md` in the same commit.
...
See also: [MODLIST.md](MODLIST.md), [CHANGELOG.md](CHANGELOG.md).
