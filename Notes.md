...
## Current pack state (0.9.16)

Living rules. CHANGELOG stays historical.

- **Version / count:** `pack.toml` **0.9.16**, **158** mods. Quest book **17 / 242**.
  Warnautics is **1.0.8** (needed for JACKPOT `cruise_missile`). The LootJS hotfix that
  dropped `aquamirae:oxygen_tank` briefly rolled the version string back to 0.9.15; the
  WDA-zip hash fix re-bumped it to 0.9.16.
- **No fresh overworld** from 0.7.1 → 0.9.16. New Cataclysm / Bosses'Rise / Born in Chaos /
