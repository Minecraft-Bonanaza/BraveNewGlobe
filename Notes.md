...
- **No fresh world** for 0.7.1 → 0.9.6. The book itself is unchanged since 0.9.0.
...
- **0.7.1 → 0.9.6 needs no new overworld.** Existing chunks keep old WDA / Born in Chaos
  placements until regenerated. Existing **Nether** chunks generated before 0.9.4 stay vanilla
  until regenerated (Incendium + Better Fortresses). 0.9.6 is a Simply More jar bump only.
...
- **Simply Swords** `1.70.2-1.21.1` (CurseForge) + **Simply More** **`1.3.0_alpha5`** (Modrinth
  ...
  is already in the pack. No worldgen / no BG datapack. Fold unique weapons into LOOT.md
  Uncommon/Rare later — they landed after the survey.
