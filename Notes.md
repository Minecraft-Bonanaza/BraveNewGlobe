...
## Overworld depth — height-patched Big Globe (as of 0.6, still in 0.6.10)
Changelog / commit titles are **0.6.10**. `pack.toml` version string is still **0.6.7**
(0.6.8–0.6.10 re-indexed the hash but did not bump the version field). Overworld bounds
...
= **−608** and Distant Horizons LODs align with real terrain. **0.6.1–0.6.10 do not change
...
## Glacier ice (`bigglobe_less_glacier`, as of 0.6.7, still in 0.6.10)
...
**0.6.8–0.6.10 did not touch glaciers.**
...
## Client-only / server-only mods (packwiz `side`, as of 0.5.2–0.6.10)
...
Dedicated servers and clients both install them. **C2ME is not in the pack** (removed 0.6.10).
