...
0.7.18 is **[SPECTRUM.md](SPECTRUM.md)** (SIG / FTB Quests design doc; FTB Quests is **not**
in the pack). **0.7.17** / **0.7.18** swap the coin economy to **Create: Numismatics**
(plus Delivery Required and the shop/stock-market stack). An **unversioned** add after
0.7.16 still includes **Create: Linear Bearing**, **VS / Sable Hose Connectors**, and
**MODLIST.md**.
