...
## Overworld depth — height-patched Big Globe (as of 0.6)
`pack.toml` version is **0.6**. Overworld bounds are **floor −608**, **ceiling +896**, sea
...
**Fresh world required.** Old saves used either default −1024…+1024 or the brief 0.6-beta
datapack compact (−464…+896). Verify F3 min Y = **−608** and Distant Horizons LODs align
with real terrain.
...
## Chunk performance — C2ME + Vertigo (as of 0.5.7, still in 0.6)
...
## Client-only / server-only mods (packwiz `side`, as of 0.5.2–0.6)
