...
## Current pack state (1.1.8)

Living rules. CHANGELOG stays historical.

- **Version / count:** `pack.toml` **1.1.8**, **210** mods. Quest book **17 / 246**
...
- **1.1.8:** shipped the CANDIDATES pending set (13 mods). Dragons Plus **1.11.9**,
  ...
  Integrated Farming, and Petrolpark load. SAnnounce is server-only; Way Better Title Bar
  is client optional, default off.
