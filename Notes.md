...
## Overworld depth — height-patched Big Globe (as of 0.6, still in 0.6.7)
`pack.toml` version is **0.6.7**. Overworld bounds are **floor −608**, **ceiling +896**, sea
...
= **−608** and Distant Horizons LODs align with real terrain. **0.6.1–0.6.7 do not change
...
## Chunk performance — C2ME + Vertigo (as of 0.5.7, still in 0.6.7)
...
## Glacier ice (`bigglobe_less_glacier`, as of 0.6.7)
...
## Client-only / server-only mods (packwiz `side`, as of 0.5.2–0.6.7)
