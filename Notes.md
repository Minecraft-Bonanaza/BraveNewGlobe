...
- **Version / count:** `pack.toml` **0.9.15**, **158** mods. Quest book **17 / 242**.
  (A 0.9.16 Warnautics jar bump landed, then the LootJS hotfix rolled the version string
  back to 0.9.15. Warnautics **1.0.8** stays.)
...
**Create: Warnautics is `1.0.8`** (0.9.16 jar bump; `pack.toml` version stayed 0.9.15).
The JACKPOT `cbc_more_content:cruise_missile` drop needs 1.0.8 — do not roll back to 1.0.3.
