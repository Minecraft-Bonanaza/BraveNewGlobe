...
world/spawn compatibility. Current pack version: **0.9.2** (**150** mods).
...
- **Survival & QoL** — seasons, thirst/diseases, farming and food, villager overhauls, and supporting
  libraries.
- **Melee weapons** — **Simply Swords** + **Simply More** (Better Combat animations). Dungeon-chest
  injection is planned via LootJS; WDA chests are still vanilla until that script is wired.
