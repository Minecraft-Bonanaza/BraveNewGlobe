...
- **Current pack version:** `0.8.5` (`pack/pack.toml` matches). **0.8.5** adds
  ...
  **owo-lib** `0.12.15.5-beta.1`. **0.8.3** self-hosts **Create: Villager Commerce**
  ...
  0.7.16–0.8.5). **Fresh world required** if you are
...
4. **Start a new world** if you are upgrading from 0.6.x (ceiling raised to **+1024**; or
   ...
   **0.7.1–0.8.5** do not change height — relaunch so the PonderJS / KubeJS
