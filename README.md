...
- **Current pack version:** `0.6` (`pack/pack.toml`). **Fresh world required** (overworld height changed).
...
- **Big Globe world generation** — height-patched 5.3.2 jar
  ...
  **+896** (DH-safe; the height lives inside BG's own jar). Glacier *ice* is tuned smaller and
  sparser than the stock Big Globe feature; the glacier biome itself is unchanged. Hand-authored
...
4. **Start a new world** if you are upgrading from any earlier pack version (0.6 changes overworld height).
   Verify F3 min Y is **−608** and Distant Horizons LODs line up with real terrain.
