...
- **Current pack version:** `0.7.0` (`pack/pack.toml` matches). **Fresh world required** if you are
  upgrading from **0.6.x** (ceiling +896 → **+1024**; or regenerate the top and clear the Distant
