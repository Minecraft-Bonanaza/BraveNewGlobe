...
- **Big Globe world generation** — with hand-authored compatibility datapacks for spawns, structures,
  ...
  the glacier biome itself is unchanged. The 0.6-beta shallow-overworld / Vertigo experiment is
  parked on branch `0.6-beta`, not on main.
...
- **[Maintainer Instructions](MaintainerInstructions.md)** — how the pack is built and how to add/update
  mods with packwiz.
- **[Notes](Notes.md)** — current overworld-depth / village / glacier rules, Creating Space,
