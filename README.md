...
- **Current pack version:** `0.7.16` (`pack/pack.toml` matches). **0.7.16** adds **Better Combat**
...
- **[Notes](Notes.md)** — current overworld-depth / village / glacier / WDA rules, Vertigo (C2ME
  removed), In Control / Sea Myths, Corpse / Throwable Rope Connector, Better Combat,
...
4. **Start a new world** if you are upgrading from 0.6.x (ceiling raised to **+1024**; or
   ...
   **0.7.1–0.7.16** do not change height — relaunch so Better Combat and the latest WDA
   compat datapack install.
