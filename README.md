...
- **Current pack version:** `0.6.11` (`pack/pack.toml` matches). **Fresh world required** if
  you are upgrading from any version before **0.6** (overworld height changed). 0.6.1–0.6.11
  do not need a new world if you are already on 0.6.
...
4. **Start a new world** if you are upgrading from any pack version before 0.6 (height changed).
   ...
   already on 0.6, keep that world. packwiz will add Corpse + Throwable Rope Connector
   (and drop C2ME if you still have it) on the next launch.
