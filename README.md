...
world/spawn compatibility. Current pack version: **0.9.10** (**156** mods).
...
- **Guidance quest book** — FTB Quests, **17 chapters / 242 quests** covering every progression
...
- **Arena bosses** — **L_Ender's Cataclysm** and **Bosses'Rise**, with Big Globe biome-tag
  datapacks (`bigglobe_cataclysm.zip`, `bigglobe_bossesrise.zip`) and kill-gated quest chapters.
  High-HP anti-melee fights; the book points at Create cannons / airships over 1v1 melee.
- **Survival & QoL** — seasons, thirst/diseases, farming and food, villager overhauls, and supporting
  libraries.
- **Melee weapons** — **Simply Swords** + **Simply More** `1.3.0_alpha5` (Better Combat
  animations; Simply More is Modrinth; 0.9.6 pairs it with Simply Tooltips `0.1.5`).
  Unique / remnant drops are **disabled** as of 0.9.7 (crafted weapon variety stays).
  WDA chests are still vanilla until LootJS is wired.
...
- **[Maintainer Instructions](MaintainerInstructions.md)** — how the pack is built and how to add/update
  mods with packwiz.
- **[QUESTS.md](QUESTS.md)** — shipped FTB Quests book (17 lines, counts, regen rules).
