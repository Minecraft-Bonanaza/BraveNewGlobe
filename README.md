...
- **Current pack version:** `0.6.7` (`pack/pack.toml`). **Fresh world required** if you are
  upgrading from any version before **0.6** (overworld height changed). 0.6.1–0.6.7 are
...
4. **Start a new world** if you are upgrading from any pack version before 0.6 (height changed).
   ...
   already on 0.6, keep that world — then explore **new** cold ocean to see 0.6.7 glaciers.
