...
- **Current pack version:** `0.7.15` (`pack/pack.toml` matches). **0.7.2–0.7.15** are
...
4. **Start a new world** if you are upgrading from 0.6.x (ceiling raised to **+1024**; or
   ...
   **0.7.1–0.7.15** do not change height — relaunch so the latest WDA compat datapack installs.
