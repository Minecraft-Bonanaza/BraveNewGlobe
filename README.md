...
- **Current pack version:** `0.7.18` (`pack/pack.toml` matches). An **unversioned** add
  after 0.7.18 is **[SPECTRUM.md](SPECTRUM.md)** (SIG / FTB Quests design doc; **FTB Quests
...
- **[Notes](Notes.md)** — current overworld-depth / village / glacier / WDA rules, Vertigo (C2ME
  ...
  Space, SPECTRUM / SIG quest-design notes, packwiz `side` flags, line-ending/hash gotcha,
