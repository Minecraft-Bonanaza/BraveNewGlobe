...
- **Current pack version:** `0.8.6` (`pack/pack.toml` matches). **0.8.6**
  ...
  **owo-lib** `0.12.15.5-beta.1`. **0.8.3** self-hosts **Create: Villager Commerce**
  ...
  0.7.16–0.8.6). **Fresh world required** if you are
...
- **[QUESTS.md](QUESTS.md)** — locked 15-line guidance roadmap. **Create Core** has
  shipped (0.8.0); other lines pending. **PonderJS is in** (Delivery Required dep).
- **[Notes](Notes.md)** — current overworld-depth / village / glacier / WDA rules, Vertigo (C2ME
  ...
  FTB Quests / Create Core, LDLib2 / owo-lib, PonderJS / KubeJS chain, Better Combat,
...
4. **Start a new world** if you are upgrading from 0.6.x (ceiling raised to **+1024**; or
   ...
   **0.7.1–0.8.6** do not change height — relaunch so the 0.8.6 hash fix
   lands, then the PonderJS / KubeJS
   chain, LDLib2, owo-lib, the self-hosted Villager Commerce jar, Linear Bearing
   1.3.5, FTB Quests / Create Core, Numismatics / Delivery Required, Hose
