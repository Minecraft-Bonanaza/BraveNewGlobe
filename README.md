...
Current pack: **0.9.23** — **164** mods. Quest book **17 chapters / 242 quests**.
...
- **Create ecosystem** — Create plus a large stack of add-ons (aeronautics, cannons, logistics,
  diesel generators, trains, radio towers, and more).
...
- **[MODLIST.md](MODLIST.md)** — human-readable mod list (164 mods).
