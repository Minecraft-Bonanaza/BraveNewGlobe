...
even when the text looks the same (this is what 0.5.4 fixed).
...
### packwiz `side` (as of 0.5.2 / 0.5.3)
...
Compat**, **Iris/Oculus For Simple Clouds**, **MapStitch**, **Mod Menu**, **Particle Rain**,
**Sodium**.

**JEI must stay `side = "both"`** (0.5.3). 0.5.2 briefly marked it client-only; that was reverted
