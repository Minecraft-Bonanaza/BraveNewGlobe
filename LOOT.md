...
Pack **0.9.6** bumped Simply More `1.2.3` → `1.3.0_alpha5` (tooltip crash fix; same items).
Pack **0.9.7** disabled Simply Swords unique / remnant **drops** (crafted weapon variety stays;
uniques are effectively uncraftable without remnants — do not fold uniques into WDA tiers while
this config holds).
Pack **0.9.8 / 0.9.10** added **L_Ender's Cataclysm** + **Bosses'Rise** after this survey.
Boss materials are already quest-rewarded; keep best boss gear boss-locked, not chest filler.
...
- [ ] Fold **Simply Swords** / **Simply More** *crafted weapon variety* into Uncommon / Rare if desired (added 0.9.2; Simply More is `1.3.0_alpha5` as of 0.9.6). Do **not** fold uniques / remnants while 0.9.7 has those drops off.
- [ ] Fold **Incendium** / **Born in Chaos** drops into the tiers (added 0.9.4, after this survey).
- [ ] Survey **Cataclysm** / **Bosses'Rise** materials for Epic / Rare (added 0.9.8 / 0.9.10). Keep signature boss gear boss-locked (already on the 0.9.10 quest rewards).
