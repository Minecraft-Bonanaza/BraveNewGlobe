...
The v1 book shipped in **0.9.0** (15 chapters / 230 quests; unchanged through **0.9.6**) — see
...
| **Simply Swords / Simply More** | — | Unique melee loot (0.9.2; Simply More `1.3.0_alpha5` as of 0.9.6); not a profession tree. Fold into dungeon loot, not a SIG |
