...
## Worlds — 0.7.6 placement vs 0.7.1 hotfix vs 0.7.0 ceiling vs 0.6 height
**0.7.2–0.7.6** are **datapack-only** When Dungeons Arise placement retunes. They do
...
**0.6.1–0.6.11 did not change height.** 0.7.0 does (ceiling only). 0.7.1–0.7.6 do not.
...
- **0.7.4** retunes underground depths: **scorched_mines −150**, **plague_asylum −300**,
  ...
  **−520** (clear of the −608 floor, still in core/molten). Relaunch; no new world.
...
regenerated. Already-generated 0.7.0–0.7.5 WDA structures keep their old positions until
those chunks are regenerated.
...
- **DH still cuts off at +896 after 0.7.0–0.7.6** — the ceiling moved in the Big Globe jar
  in 0.7.0 (0.7.1–0.7.6 did not change height). Clear the Distant Horizons LOD cache and
