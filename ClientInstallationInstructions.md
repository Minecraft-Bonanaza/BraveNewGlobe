...
- **Pack version:** `0.7.18` (`pack.toml`). An unversioned add after 0.7.18 is
  [SPECTRUM.md](SPECTRUM.md) (quest-design notes for maintainers; **FTB Quests is not in
  the pack** — no in-game questbook). **0.7.17** / **0.7.18** swap the coin economy
  to Create: Numismatics (plus Delivery Required and shops). An unversioned add after 0.7.16
  still includes Create: Linear Bearing, VS / Sable Hose Connectors, and [MODLIST.md](MODLIST.md).
...
## Worlds — SPECTRUM.md (docs) vs 0.7.18 Numismatics vs unversioned Linear Bearing / Hose Connectors vs 0.7.16 Better Combat vs 0.7.15 placement vs 0.7.1 hotfix vs 0.7.0 ceiling vs 0.6 height
The **unversioned** add after 0.7.18 is **[SPECTRUM.md](SPECTRUM.md)** — a Special Interest
Group framework for a future FTB Quests book. It does **not** change mods, world height, or
structure placement. **FTB Quests is not in the pack**; there is no in-game questbook yet.
**No new world.**
...
- **Unversioned (after 0.7.16)** adds **Create: Linear Bearing** `1.2.6` (Sable physics
  ...
  Sable ships), plus **[MODLIST.md](MODLIST.md)** (129 mods then; **135** as of 0.7.18).
...
- **Dedicated server** — client-only mods (Iris, Sodium, ImmediatelyFast, Mod Menu,
  ...
  **Create: Linear Bearing**, **VS / Sable Hose Connectors**, **Create: Numismatics**
  ...
  Utils), **Create Aeronautics: Delivery Required**, and the patched **Big Globe**
