...
## Worlds — 0.7.16 Better Combat vs 0.7.15 placement vs 0.7.1 hotfix vs 0.7.0 ceiling vs 0.6 height
...
**0.6.1–0.6.11 did not change height.** 0.7.0 does (ceiling only). 0.7.1–0.7.16 do not.
...
- **Dedicated server** — client-only mods (Iris, Sodium, ImmediatelyFast, Mod Menu,
  ...
  **Throwable Rope Connector**, **Sable**, **When Dungeons Arise**, **Better Combat**, and the patched **Big Globe**
...
- **DH still cuts off at +896 after 0.7.0–0.7.16** — the ceiling moved in the Big Globe jar
  in 0.7.0 (0.7.1–0.7.16 did not change height). Clear the Distant Horizons LOD cache and
