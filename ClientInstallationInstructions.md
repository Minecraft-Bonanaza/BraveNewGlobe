...
- **Pack version:** `0.7.18` (`pack.toml`). **0.7.17** / **0.7.18** swap the coin economy
...
## Worlds — 0.7.18 Numismatics vs unversioned Linear Bearing / Hose Connectors vs 0.7.16 Better Combat vs 0.7.15 placement vs 0.7.1 hotfix vs 0.7.0 ceiling vs 0.6 height
