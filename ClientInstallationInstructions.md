...
## Worlds — 0.6 height vs 0.6.6 glaciers
...
**0.6.1–0.6.6** only change ocean glaciers (datapack `bigglobe_less_glacier`). If you are
...
- **0.6.6** makes glaciers **fewer and smaller**: colder temperature bar, and cutoff
  **C = 0.4** on both the ice and the glacier biome so they shrink together (Aquamirae
  shrinks too).

Already-generated cold ocean stays as it was; explore **new** ocean (or delete those chunks)
to see the 0.6.6 ice.
