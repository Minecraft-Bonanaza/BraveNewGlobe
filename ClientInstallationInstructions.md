...
- **Pack version:** `0.7.18` (`pack.toml`). An unversioned add after 0.7.18 is
  **Create: Villager Commerce** (villagers buy from player shops; relaunch). Another
  unversioned add after 0.7.18 is [SPECTRUM.md](SPECTRUM.md) (quest-design notes for
  maintainers; **FTB Quests is not in the pack** — no in-game questbook).
  **0.7.17** / **0.7.18** swap the coin economy to Create: Numismatics (plus Delivery
  Required and shops). An unversioned add after 0.7.16 still includes Create: Linear
  Bearing, VS / Sable Hose Connectors, and [MODLIST.md](MODLIST.md).
...
## Worlds — Villager Commerce vs SPECTRUM.md (docs) vs 0.7.18 Numismatics vs unversioned Linear Bearing / Hose Connectors vs 0.7.16 Better Combat vs 0.7.15 placement vs 0.7.1 hotfix vs 0.7.0 ceiling vs 0.6 height
The latest **unversioned** add after 0.7.18 is **Create: Villager Commerce** `1.0.1` —
Merchant Stalls so villagers automatically buy from player shops (Numismatics coins).
It does **not** change world height or structure placement. Relaunch so packwiz
downloads the jar. **No new world.**

Another **unversioned** add after 0.7.18 is **[SPECTRUM.md](SPECTRUM.md)** — a Special
Interest Group framework for a future FTB Quests book. It does **not** change mods,
world height, or structure placement. **FTB Quests is not in the pack**; there is no
in-game questbook yet. **No new world.**
...
The **unversioned** add after 0.7.16 adds **Create: Linear Bearing** `1.2.6` (Sable physics
sliders) and **VS / Sable Hose Connectors** `0.1.8` (fluid/item/rotation/energy hoses
across Sable ships), plus a human-readable **[MODLIST.md](MODLIST.md)**. They do **not**
change world height or structure placement. Relaunch so packwiz downloads the jars.
**No new world.**
...
**0.6.1–0.6.11 did not change height.** 0.7.0 does (ceiling only). 0.7.1–0.7.18 do not.
...
- **Unversioned (after 0.7.16)** adds **Create: Linear Bearing** `1.2.6` (Sable physics
  ...
  Sable ships), plus **[MODLIST.md](MODLIST.md)** (129 mods then; **136** as of Villager
  Commerce). Relaunch; no new world.
...
- **Unversioned (after 0.7.18)** adds **[SPECTRUM.md](SPECTRUM.md)** (SIG / FTB Quests
  design; **FTB Quests is not in the pack**), then **Create: Villager Commerce**
  `1.0.1` (villagers buy from player Merchant Stalls). Relaunch; no new world.
...
- **Dedicated server** — client-only mods (Iris, Sodium, ImmediatelyFast, Mod Menu,
  ...
  **Create: Linear Bearing**, **VS / Sable Hose Connectors**, **Create: Numismatics**
  ...
  Utils), **Create Aeronautics: Delivery Required**, **Create: Villager Commerce**, and
  the patched **Big Globe**
  ...
  **C2ME is not in the pack.** Drive-By-Wire With Sable is not in the pack. MapStitch is
  not in the pack. Numismatic Overhaul / owo-lib are not in the pack.
...
- **DH still cuts off at +896 after 0.7.0** — the ceiling moved in the Big Globe jar
  in 0.7.0 (0.7.1 onward, including 0.7.18, did not change height). Clear the Distant Horizons LOD cache and relaunch (or start a new world).
