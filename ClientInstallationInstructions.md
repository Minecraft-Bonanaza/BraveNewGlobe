...
## Worlds — 0.6 height vs later glacier / spawn / C2ME / 0.6.11 updates
...
**0.6.1–0.6.11 do not change height.** If you are already on a 0.6 world, **keep it**.
...
- **0.6.11** adds **Corpse** (lootable body on death) and **Create Aeronautics: Throwable
  ...
  `pack.toml` version string now matches (**0.6.11**).
...
- **Dedicated server** — client-only mods (Iris, Sodium, ImmediatelyFast, Mod Menu,
  ...
  **Throwable Rope Connector**, **Sable**, and the patched **Big Globe** jar are
  `side = "both"` and do install on the server. **Too Fast** is `side = "server"` and
