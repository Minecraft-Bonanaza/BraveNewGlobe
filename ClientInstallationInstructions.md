...
## Worlds — 0.7.15 placement vs 0.7.1 hotfix vs 0.7.0 ceiling vs 0.6 height
...
**0.6.1–0.6.11 did not change height.** 0.7.0 does (ceiling only). 0.7.1–0.7.15 do not.
...
- **DH still cuts off at +896 after 0.7.0–0.7.15** — the ceiling moved in the Big Globe jar
  in 0.7.0 (0.7.1–0.7.15 did not change height). Clear the Distant Horizons LOD cache and
