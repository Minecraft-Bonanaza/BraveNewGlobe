...
## Worlds — 0.6 height vs 0.6.2 glaciers
...
**0.6.1 and 0.6.2** only change ocean glacier ice (datapack `bigglobe_less_glacier`). If you are
already on a 0.6 world, **keep it**. 0.6.1 generated **no ice** (the new `glacier_field` never
cleared its cutoff). 0.6.2 fixes that: ice sheets at deep/cold cores, thinning to open water
toward the shallows. Already-generated cold ocean stays as it was; explore **new** ocean (or
delete those chunks) to see the v2 ice.
