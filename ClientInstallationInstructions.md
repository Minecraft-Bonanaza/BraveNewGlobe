...
## Worlds — 0.7.0 ceiling vs 0.6 height vs later glacier / spawn updates
...
**0.6.1–0.6.11 did not change height.** 0.7.0 does (ceiling only).
...
- **DH still cuts off at +896 after 0.7.0** — the ceiling moved in the Big Globe jar. Clear the
  Distant Horizons LOD cache and relaunch (or start a new world). The floor is still −608.
