...
- **Pack version:** `0.9.2` (**150** mods) — includes a guidance-only FTB Quests book
  (15 chapters / 230 quests; unchanged since 0.9.0). Open it in-game from the quests button.
  0.9.1–0.9.2 add LootJS + Simply Swords / Simply More; WDA dungeon chests are still vanilla.
...
- **Datapacks** — you do **not** install datapacks manually. packwiz drops them in the instance
  ...
  auto-sync.
- **Upgrading 0.8.x → 0.9.2** — no fresh world. The quest book is new as of 0.9.0 (Create Core
  was rewritten, so prior Create Core ticks may look mixed or reset). Other chapters start empty.
  0.9.1–0.9.2 are jar/script adds — relaunch so packwiz pulls LootJS and Simply Swords.
- **Upgrading 0.9.0 → 0.9.2** — no fresh world. Relaunch. WDA chests stay vanilla until loot
  injection is wired; Simply Swords weapons appear in JEI / crafting immediately.
